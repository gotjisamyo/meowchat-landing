...
const BUSINESS_TYPES = [
  { id: 'food',     icon: '🍱', label: 'ร้านอาหาร' },
  { id: 'fashion',  icon: '👗', label: 'แฟชั่น' },
  { id: 'spa',      icon: '💆', label: 'สปา/ความงาม' },
  { id: 'online',   icon: '📦', label: 'ขายออนไลน์' },
  { id: 'realestate', icon: '🏠', label: 'อสังหา/B2B' },
  { id: 'course',   icon: '🎓', label: 'คอร์ส/สอน' },
  { id: 'service',  icon: '🔧', label: 'ช่าง/บริการ' },
